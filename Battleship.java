...
public class Battleship {
    ...
    private static String askForGuess(Player p, Player opp) {
        ...
        while (true) {
            ...
            System.out.print("Type in column (1-11): ");
            col = reader.nextInt();
            oldCol = col;
        ...
        while (p.numOfShipsLeft() > 0) {
            for (Ship s : p.ships) {
                ...
                while (true) {
                    ...
                    if (col >= 0 && col <= 10 && row != -1 && dir != -1) // Check valid input
                    {
